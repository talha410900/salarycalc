...
export const metadata: Metadata = {
  title: "Alternative Minimum Tax (AMT) Calculator 2025 | Calculate AMT Owed",
  description: "Determine if you owe Alternative Minimum Tax based on 2025 exemption amounts and rates. Free AMT calculator.",
  keywords: "AMT calculator, alternative minimum tax, AMT 2025, minimum tax calculator, tax preference items",
  openGraph: {
    title: "Alternative Minimum Tax (AMT) Calculator 2025 | Calculate AMT Owed",
    description: "Determine if you owe Alternative Minimum Tax based on 2025 exemption amounts and rates.",
  },
}
      ...
      <main className="flex-1 py-12">
        <div className="container mx-auto px-4 max-w-4xl">
          <div className="text-center mb-10">
            <h1 className="text-3xl md:text-4xl font-bold text-foreground mb-4">Alternative Minimum Tax (AMT) Calculator 2025</h1>
          ...
          <div className="prose prose-sm max-w-none mb-8 text-muted-foreground">
            <p className="text-base leading-relaxed">
              Use our free <strong>alternative minimum tax calculator</strong> to determine if you owe AMT for 2025. 
              This <strong>AMT calculator</strong> calculates AMTI, applies 2025 exemptions ($88,100 single, $137,000 married), and computes tentative minimum tax. Enter taxable income and filing status for results.
            </p>
          </div>
          ...
          <Card className="mt-12">
            ...
            <CardContent className="prose prose-sm max-w-none text-muted-foreground">
              <p className="leading-relaxed">
                The calculator first calculates your Alternative Minimum Taxable Income (AMTI) by adding tax preference items to your regular taxable income. It then applies the 2025 AMT exemption ($88,100 single, $137,000 married) with phaseout reductions for high earners. The AMT base is calculated by subtracting the exemption from AMTI. Finally, it computes the tentative minimum tax using AMT rates: 26% on the first $239,100 and 28% on amounts above that threshold. You only pay AMT if this tentative minimum tax exceeds your regular tax liability.
              </p>
            </CardContent>
          </Card>
