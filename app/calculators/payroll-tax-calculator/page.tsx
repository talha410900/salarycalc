...
export const metadata: Metadata = {
  title: "Payroll Tax Calculator (2025-2026) | Calculate Net Pay After Taxes",
  description: "Calculate your net pay by deducting Federal Tax, Social Security, and Medicare from gross wages for the 2025-2026 tax year. Free payroll tax calculator.",
  keywords: "payroll tax calculator, net pay calculator, 2025-2026 payroll taxes, federal tax calculator, social security tax, medicare tax",
  openGraph: {
    title: "Payroll Tax Calculator (2025-2026) | Calculate Net Pay After Taxes",
    description: "Calculate your net pay by deducting Federal Tax, Social Security, and Medicare from gross wages for the 2025-2026 tax year.",
  },
}
      ...
      <main className="flex-1 py-12">
        <div className="container mx-auto px-4 max-w-4xl">
          <div className="text-center mb-10">
            <h1 className="text-3xl md:text-4xl font-bold text-foreground mb-4">Payroll Tax Calculator (2025-2026)</h1>
            <p className="text-lg text-muted-foreground max-w-2xl mx-auto">
              Calculate net pay by deducting Federal Tax, Social Security, and Medicare from gross wages for the 2025-2026 tax year.
            </p>
          </div>

          <div className="prose prose-sm max-w-none mb-8 text-muted-foreground">
            <p className="text-base leading-relaxed">
              Our <strong>payroll tax calculator</strong> helps you understand <strong>how to calculate payroll taxes</strong> for 2025-2026 by deducting federal tax, Social Security (6.2%), and Medicare (1.45%) from gross wages. 
          ...
          <Card className="mt-12">
            <CardHeader>
              <h2 className="text-2xl font-bold text-foreground">How the Payroll Tax Calculator Works</h2>
            </CardHeader>
            <CardContent className="prose prose-sm max-w-none text-muted-foreground">
              <p className="leading-relaxed">
                The <strong>payroll tax calculator</strong> first converts your gross pay to annual income based on your pay period. It then calculates federal income tax using 2025-2026 tax brackets and standard deductions ($15,750 single, $31,500 married, $23,625 head of household). Social Security tax is calculated at 6.2% on wages up to $176,100, and Medicare tax is 1.45% on all wages, plus an additional 0.9% for high earners (income over $200,000 single or $250,000 married). If you select a state, state income tax is also calculated. Finally, all taxes are converted back to your pay period and deducted from gross pay to show your net pay.
              </p>
          ...
          {/* Formulas Used in the Payroll Tax Calculator */}
          <Card className="mt-6">
            <CardHeader>
              <h2 className="text-2xl font-bold text-foreground">Formulas Used in the Payroll Tax Calculator</h2>
            </CardHeader>
            <CardContent className="prose prose-sm max-w-none text-muted-foreground">
              ...
              <Accordion type="single" collapsible className="w-full">
                <AccordionItem value="accuracy">
                  ...
                  <AccordionContent className="text-muted-foreground leading-relaxed">
                    The calculator uses official 2025-2026 federal tax brackets, standard deductions, and FICA rates. Results are estimates and may vary slightly from actual paychecks due to W-4 elections, additional deductions, or state-specific calculations. For exact amounts, consult your payroll department or tax professional.
                  </AccordionContent>
                </AccordionItem>
              </Accordion>
            </CardContent>
